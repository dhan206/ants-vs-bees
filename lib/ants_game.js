...
class Place {
  ...
  _addInsect(insect){
    if (insect instanceof Bee){
      ...
      return true;
        ...
        console.log("ant is already in this spot");
        if (this._ant.container && !insect.container) { // adds new ant to exisiting container
            console.log("adds new ant to exisiting container");
            ...
            console.log("adds existing ant into new container, replaces its spot with container");
            ...
            console.log("doesnt deploy if both are containers or both are not containers");
            return false;
  ...
  _removeInsect(insect){
    if(insect instanceof Bee){
        ...
        if (this._ant.contained !== undefined) { // replaces container ant with the contained ant
...
var Ants = {
  ...
  Bodyguard: class extends Ant {
      constructor() {
          super(2,4, new NoactStrategy(), new VisibleStrategy(), new NotwatersafeStrategy(), new DefaultReduceArmor(), new ContainerStrategy());
