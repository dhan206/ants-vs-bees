...
class Insect {
  constructor(armor, place, watersafe) {
    this._armor = armor;
    this._place = place;
    if(watersafe === undefined) {
        this._watersafe = false; // default to false
    } else {
...
class Ant extends Insect {
  constructor(armor, cost, actbehavior, watersafe, place){
    super(armor, place, watersafe);
  ...
  deployAnt(place, ant){
    if(this._food >= ant.foodCost){
        if(!place.water || place.water === ant.watersafe ) {
            ...
            return false; //could not place the ant, not watersafe
        }
    }
    else {
...
class Hive extends Place {
  ...
  addWave(attackTurn, numBees){
    ...
    for(var i=0; i<numBees; i++){
      var bee = new Bee(this._beeArmor, this, true); // default true for watersafe bees
      wave.push(bee);
      bee.place = this;
...
var Ants = {
  ...
  Grower : class extends Ant {
      constructor() {
          super(1,2, new IncreaseFoodStrategy());
          this._name = 'Grower';
      }
  },
  ...
  Thrower : class extends Ant {
      constructor()  {
          super(1,4, new ThrowLeavesStrategy());
          this._name = 'Thrower';
          this._damage = 1;
      }
  },
  ...
  Hungry : class extends Ant {
      constructor() {
          super(1,4, new EatDigestStrategy());
          this._name = 'Hungry';
  ...
  Scuba : class extends Ant {
      constructor() {
          super(1,5, new ThrowLeavesStrategy(), true);
          this._name = "Scuba";
          this._damage = 1;
      }
  },
